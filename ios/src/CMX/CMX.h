...
//  CMX
//
//  Created by abhisbha  on 25/10/2013.
 ...
 * 1. CMX Mobile App Server Overview
 * 2. Power of the CMX SDK
 * 3. Brief Overview of the CMX SDK
 *
 *######################### CMX Mobile App Server Overview ###################################
 *
 *The Cisco CMX Mobile App server in conjunction with the Cisco Mobility Services Engine
 ...
 *Controller managing a venue. The MSE then forwards this information to the Mobile App
 *Server via its Cloud Connector. The CMX SDK gets the information from the mobile app server,
 ...
 *download the blebeacon information on a floor.
 *
 *
 ...
 *push notification registration key, then register using the network information in the venues list and the push
 *notification key. It will then be able to receive client location.
