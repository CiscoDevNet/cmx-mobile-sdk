...
/*!
 * @property lastLocationUpdateTime
 * The last time the location of the client got updated.
 */
 ...
 *  @discussion Initializes the object with the venueId, floorId, mapCoordinate,deviceId and zoneId
 *
