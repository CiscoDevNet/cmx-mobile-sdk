...
-(void) setClientLocation:(CMXClientLocation*)location {
    ...
    //CMXLog(@"We are in set Client Location");
    if([location.floorId isEqualToString:_floor.identifier]) {
        
        //CMXLog(@"floor id is %@",location.floorId);
        //CMXLog(@"floor identifier is %@",_floor.identifier);
        ...
        CMXLog(@"The client is not located");
...
-(void) locationManager:(CLLocationManager *)manager didUpdateHeading:(CLHeading *)newHeading {
    ...
    //CMXLog(@"Location Manager Updated heading");
    ...
    //CMXLog(@"CMX Heading is %f",heading);
    
    heading = [CMXClient instance].loadUserHeading;
    //CMXLog(@"Senion heading is %f",heading);
